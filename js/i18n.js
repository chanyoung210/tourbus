$(function () {
  ...
  var TAX_REFUND_I18N = {
    en: {
      ...
      "tax.compare.secondary.item3.desc": "Refund processed within about a month after departure",
    ...
    zh: {
      ...
      "tax.visual.sub": "安全·简便·快速",
      "tax.tab.compare": "对比",
      "tax.tab.promotion": "促销",
      "tax.tab.howto": "使用方法",
      "tax.feature.title": "机场即时退税服务特点",
      "tax.feature.text1": "支持支付宝 / 微信支付人民币退税，便捷且快速",
      "tax.feature.text2": "相比市区退税更安全、更方便，提供",
      "tax.feature.point": "即时到账退税",
      ...
      "tax.compare.primary.item1.desc": "即时处理，出境前可直接领取现金或支付宝微信到账",
      ...
      "tax.compare.secondary.badge": "市区退税 / 市区自助机预约退税（退税信封 QR）",
      "tax.compare.secondary.title": "传统市区退税 / 线上退税",
      "tax.compare.secondary.item1.title": "难以确认",
      "tax.compare.secondary.item1.desc": "因运营方不同，退税详情难以确认",
      "tax.compare.secondary.item2.title": "不可更改方式",
      "tax.compare.secondary.item2.desc": "市区申请后在机场无法更改退税方式",
      "tax.compare.secondary.item3.title": "到账时间久",
      "tax.compare.secondary.item3.desc": "离境确认后约1个月内处理",
      "tax.promo.title": "特别外币促销",
      "tax.promo.highlight": "安检后 28号登机口 - 人工柜台",
      "tax.promo.subtitle": "机场人工柜台退税",
      "tax.promo.place.label": "退税地点",
      "tax.promo.place.value": "安检后 28号登机口人工柜台（24小时）",
      "tax.promo.time.label": "退税时间",
      "tax.promo.time.value": "现场即时办理",
      "tax.promo.currency.label": "币种",
      "tax.promo.currency.value": "可选 KRW / USD / CNY / JPY",
      "tax.promo.benefit.label": "优惠",
      "tax.promo.banner.line1": "在人工柜台进行大额现金退税时",
      ...
      "tax.howto.note1": "※ 退税金额低于 ₩75,000 或有 'O' 标记<br>（无需海关确认，可直接领取现金）",
      "tax.howto.note2": "※ 退税金额高于 ₩75,000（或有 'X' 标记）",
    ...
    ja: {
      ...
      "tax.visual.sub": "安全・簡単・高速",
      "tax.tab.compare": "比較",
      "tax.tab.promotion": "プロモーション",
      "tax.tab.howto": "利用方法",
      "tax.feature.title": "空港即時還付サービスの特長",
      "tax.feature.text1": "WeChat Payの自国通貨で、簡単かつ迅速な還付",
      ...
      "tax.compare.primary.title": "現金 / WeChat Pay 空港即時還付",
      "tax.compare.primary.item1.title": "リアルタイムタックスリファンド",
      "tax.compare.primary.item1.desc": "即時処理、出国前に現金受取、即時入金",
      "tax.compare.primary.item2.title": "現金4通貨 (KRW, USD, CNY, JPY)",
      "tax.compare.primary.item2.desc": "WeChat Payで人民元(CNY)即時還付",
      "tax.compare.primary.item3.title": "スタッフの正確な案内",
      "tax.compare.primary.item3.desc": "現場で内訳を目視確認",
      ...
      "tax.compare.secondary.item3.desc": "出国後、1か月以内に処理",
